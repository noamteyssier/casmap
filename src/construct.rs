...
use crate::{constant::Constant, spacer::Spacer, utils::reverse_complement};
...
impl Construct {
    ...
    pub fn r1(&self) -> String {
        ...
        s_iter.zip(c_iter).fold(String::new(), |mut seq, (s, c)| {
    ...
    pub fn r2(&self) -> String {
        ...
        let seq = s_iter.zip(c_iter).fold(String::new(), |mut seq, (s, c)| {
            seq.push_str(c.sequence());
            seq.push_str(s.sequence());
            seq
        });
